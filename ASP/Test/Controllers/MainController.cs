...
using Test.Models;
using Test.DataAbstractionLayer;
...
namespace Test.Controllers
{
    public class MainController : Controller
    {
        ...
        public ActionResult SaveBook()
        {
            ...
            if (Request.Params["inputTitle_insert"].Equals("") || Request.Params["inputAuthor_insert"].Equals("") || Request.Params["inputPages_insert"].Equals("") || Request.Params["inputPrice_insert"].Equals(""))
            {
        ...
        public ActionResult UpdateBook()
        {
            ...
            if (Request.Params["inputTitle_update"].Equals("") || Request.Params["inputAuthor_update"].Equals("") || Request.Params["inputPages_update"].Equals("") || Request.Params["inputPrice_update"].Equals(""))
            {
                return View("ErrorAdd");
            }
